...
<div class="flex-container">
 ...
 <div><a href="https://www.youtube.com/channel/UC2AOsupmlTndL6QfAEKwrkA" target="_blank" class="no-external-link-icon"><InfoCard title="YouTube" logo="fa-brands fa-youtube"/></a></div>
  ...
  <!-- <div><a href="https://github.com/SamLefebvre" target="_blank" class="no-external-link-icon"><InfoCard title="GitHub" logo="fab fa-github"/></a></div> -->

  <div><RouterLink to="/contact" class="home-link"><InfoCard title="Contact" logo="fa-solid fa-address-card"/></RouterLink></div>
  
  <div><a href="https://www.linkedin.com/in/samuellefebvre/" target="_blank" class="no-external-link-icon"><InfoCard title="LinkedIn" logo="fa-brands fa-linkedin"/></a></div>
